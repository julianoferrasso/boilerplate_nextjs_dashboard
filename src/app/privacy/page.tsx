export default function Privacy() {
    return (
        <div className="className">
            ...
            Conforme previsto no Artigo 18 da LGPD, é assegurado ao Usuário, a qualquer momento, mediante requisição à Empresa por meio do e-mail contato@automarticles.com, requerer:
