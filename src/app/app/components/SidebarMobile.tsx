...
export default function SidebarMobile() {
    ...
    return (
        <>
            <div className={`bg-slate-700 flex flex-col ${isCollapsed ? "w-[350px] " : "w-0"} `}>
                ...
                <Button
                    ...
                    className={`rounded-full transition-transform ${isCollapsed ? "rotate-180" : ""} -mr-0`}
                >
            ...
            {isCollapsed &&
                <div className={`flex flex-col ${isCollapsed ? "w-[350px] min-h-screen" : "w-[350px] min-h-screen"} `}>
                    <Link href="#" className="flex items-center gap-4" prefetch={false}>
                        <Mountain className="h-6 w-6" />
                        <span className="text-lg font-semibold text-text-primary">mPlaces Admin</span>
                    </Link>
